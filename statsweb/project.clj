(defproject statsweb "0.1.0-SNAPSHOT"
                  ...
                  {:builds
                   {:app
                    {:source-paths ["src/cljs" "src/cljc" "env/dev/cljs"]
                     :figwheel {:on-jsload "statsweb.core/mount-components"}
                     :compiler
                     {:main "statsweb.app"
                      :asset-path "/js/out"
                      :output-to "target/cljsbuild/public/js/app.js"
